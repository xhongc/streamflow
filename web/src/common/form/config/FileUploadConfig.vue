<template>
    <div>
        ...
        <el-form-item label="数量限制">
            ...
            <el-input-number class="max-fill" controls-position="right" :precision="0" size="small"
                v-model="value.maxNumber" placeholder="最多上传几张图片" />
        </el-form-item>
        <el-form-item label="大小限制">
            <tip slot="label" content="限制单个文件最大大小-MB（为0则不限制）">大小限制</tip>
            <el-input-number class="max-fill" controls-position="right" :precision="1" size="small"
                v-model="value.maxSize" placeholder="单个文件最大大小" />
        </el-form-item>
